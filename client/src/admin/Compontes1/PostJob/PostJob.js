...
function PostJob() {
  ...
  const createPost = async (jobDetails, e) => {
    e.preventDefault();
  ...
  return (
    <div className="company">
      ...
      <div className="companyItem">
        ...
        <form className="addEmployer">
          ...
          <div className="form-item">
            <div className="input-aria1">
              ...
              <input type="radio" value="Work from office" name="workmode" onClick={(e) => { setJobDetails({ ...jobDetails, mode: e.target.value }) }} /><label>Work from office</label>
              <input type="radio" value="Work from home" name="workmode" onClick={(e) => { setJobDetails({ ...jobDetails, mode: e.target.value }) }} /> <label>Work from home</label>
              <input type="radio" value="Hybrid" name="workmode" onClick={(e) => { setJobDetails({ ...jobDetails, mode: e.target.value }) }} /> <label>Hybrid</label>
              <input type="radio" value="Temp WFH" name="workmode" onClick={(e) => { setJobDetails({ ...jobDetails, mode: e.target.value }) }} /> <label>Temp WFH</label>
            </div>
          </div>
          <div className="form-item">
            <select
              value={jobDetails.testrole}
              onChange={(e) => { setJobDetails({ ...jobDetails, testrole: e.target.value }) }}
              placeholder="select"
            >
          ...
          <div className="form-item">
            <div className="input-aria1">
              ...
              <input type="radio" value="startup" name="type" onClick={(e) => { setJobDetails({ ...jobDetails, companyType: e.target.value }) }} /><label>startup</label>
              <input type="radio" value="indian MNC" name="type" onClick={(e) => { setJobDetails({ ...jobDetails, companyType: e.target.value }) }} /> <label>Indian MNC</label>
              <input type="radio" value="foreign MNC" name="type" onClick={(e) => { setJobDetails({ ...jobDetails, companyType: e.target.value }) }} /> <label>Foreign MNC</label>
              <input type="radio" value="corporate" name="type" onClick={(e) => { setJobDetails({ ...jobDetails, companyType: e.target.value }) }} /> <label>Corporate</label>
            </div>
          </div>
        ...
        <button type="submit" className="add-btn" onClick={(e) => submitForm(jobDetails, e)}>
          Add Employer
        </button>
      </div>
    </div>
