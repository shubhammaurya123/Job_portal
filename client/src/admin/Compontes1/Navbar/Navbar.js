    ...
    <div className="Navbar">
      <div className="inner-bar">
        <ul className="list">
            ...
            <div className="list-item extra">
              <ul className="list-style-nav">
                ...
                <li className="item-gap">
                  <a href="/admin/company/addEmployer" className="text-decorate" >
                      Add New Employer
                  </a>
                </li>
                <li className="item-gap">
                  <a href="/admin/company/allEmployer" className="text-decorate" >
                       All Employer
                  </a>
                </li>
          ...
          <li className={`navbarlistItem  ${activeTab === "postjob" ?"active" :""}`}  onClick={() => setActiveTab("postjob")}>
            <div className="navItemtoggle">
          ...
          {activeTab ==="postjob" && (
            <div className="list-item extra">
              <ul className="list-style-nav">
                ...
                <li className="item-gap">
                <a href="/admin/postjob/AllPostJobs" className="text-decorate">
                {" "}
          ...
          {activeTab==="setting" && (
            <div className="list-item extra">
              <ul className="list-style-nav">
                ...
                <li className="item-gap">
                  <a href="/admin/setting/roles&permission"  className="text-decorate" >
                    Roles and Permisson{" "}
                  </a>
                </li>
                <li className="item-gap">Email Setting</li>
                <li className="item-gap">
                  <a href="/admin/setting/viewpermission"  className="text-decorate" >
                    View Permission{" "}
                  </a>
                </li>
              </ul>
