...
const EmpAddFeatured = () => {
  ...
  const val = localStorage.getItem("itemValue");
  ...
  return (
    <div className="company">
      <h2 className="company-text">Add Featured!</h2>
      ...
      <div className="companyItem">
        ...
        <button className="add-btn" onClick={(e) => submitForm(jobDetails, e)}>
             Add Featured
        </button>
      </div>
    </div>
