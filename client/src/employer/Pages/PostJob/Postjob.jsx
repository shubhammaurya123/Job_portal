...
const EmpPostJob = () => {
  ...
  const submitForm = (jobDetails, e) => {
    ...
    const newJobDetails = { ...jobDetails, skills: tags };

    console.log(activeTab);

    if (!check(newJobDetails, e)) {
      return;
    }
    if (isLoggedIn) {
      ...
      <div className="company">
        ...
        <div className="companyItem">
          ...
          <div className="posjob-icon-all-style">
            <div
              className={`message  ${
                activeTab === "jobdetails" && "activeVal"
              }`}
            >
            ...
            <div
              className={`message  ${activeTab === "payments" && "activeVal"}`}
            >
              <span className="icon-style-postjob">
                <GiMoneyStack />
              </span>
            ...
            </div>
            {
              <div
                className={`message  ${
                  activeTab === "confirmation" && "activeVal"
                }`}
              >
                <span className="icon-style-postjob">
                  <FiCheckCircle />
          ...
          {activeTab === "payments" && <h1> Payments system</h1>}
          {activeTab === "confirmation" && <h1> confirmation</h1>}
          <button
            className="add-btn"
            onClick={(e) => submitForm(jobDetails, e)}
          >
            {activeTab === "confirmation" ? "Post Job" : "Next"}
          </button>
        </div>
      </div>
